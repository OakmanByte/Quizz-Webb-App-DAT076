...
public class LeaderboardDAOTest {
    ...
    public void setUp() {
       acc1= new Account("Rebecka","rebecka@me.com","psgjsg","user","Science", 20,null);
       acc2= new Account("Emma","reemma@me.com","psdsgjsg","user","Science", 20,null);
       acc3= new Account("AntonE","antone@me.com","psgsdfjsg","user","Science", 20,null);
